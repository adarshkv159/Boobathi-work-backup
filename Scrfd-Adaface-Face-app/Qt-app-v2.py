...
class SCRFD:
    ...
    def _create_interpreter(self):
        # NOTE: In this GUI we force SCRFD CPU only by passing use_npu=False.
        delegates = []
        if self.use_npu:
            try:
...
class AppConfig:
    ...
    # SCRFD forced CPU always
    scrfd_force_cpu: bool = True

    # Recognition toggle (delegate ON/OFF)
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Recognition NPU toggle (checkable button)
    ...
    def load_models(self):
        try:
            ...
            self.detector = SCRFD(
                ...
                nms_thresh=0.4,
                use_npu=False,        # forced CPU
                delegate_path="",     # unused
