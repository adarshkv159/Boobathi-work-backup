...
"""
Qt Stylesheet Theme for Object Detection Demo
Color Palette:
- Primary Cyan: #02a6b1
- Primary Green: #29a955
- Dark Background: #000000
- Panel Background: #121a26
- Input Background: #0f1621
- Border: #2c3e50
"""
...
/* Enhanced Results and Log panels */
QTextEdit {
...
def get_dark_palette():
    """Returns a QPalette configured for dark theme"""
    ...
    pal.setColor(QPalette.AlternateBase, QColor("#121a26"))
    pal.setColor(QPalette.ToolTipBase, QColor("#000000"))
    pal.setColor(QPalette.ToolTipText, QColor("#ffffff"))
    pal.setColor(QPalette.Text, QColor("#ecf0f1"))
    pal.setColor(QPalette.Button, QColor("#1a2332"))
...
def apply_theme(app, window):
    """
    Apply the complete dark theme to Qt application
